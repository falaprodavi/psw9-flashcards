...
from flashcard.models import Categoria, Flashcard, Desafio, FlashcardDesafio
...
def deletar_flashcard(request, id):
    if not request.user :
        messages.add_message(request, constants.ERROR, 'Você não pode deletar este flashcard') 
        return redirect('/flashcard/novo_flashcard')
